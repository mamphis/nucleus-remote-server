...
import EditProfileView from '@/views/Misc/EditProfileView.vue';
...
import IssueView from '@/views/Misc/IssueView.vue';
import LoginView from '@/views/Misc/LoginView.vue';
import NotificationView from '@/views/Misc/NotificationView.vue';
import ResetPassword from '@/views/Misc/ResetPassword.vue';
