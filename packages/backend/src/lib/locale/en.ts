const translations = {
    ...
    'error.400.invalidTenantIdFormat' : 'Invalid tenant id format: {0}.',
    ...
    'error.403.clientAlreadyUpdated': 'The client has already been updated.',
    'error.403.featureNotEnabled': 'The feature is not enabled.',
    ...
    'error.404.noClientFound': 'The client with id "{0}" was not found.',
